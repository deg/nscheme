//! GENERATED — do not edit. Unicode CaseFolding-17.0.0.txt.
//!
//! Case-folding tables for `char-foldcase` (simple) and
//! `string-foldcase` (full), per R7RS §6.6 / §6.7. Code points not
//! listed fold to themselves. Regenerate from the Unicode UCD
//! CaseFolding.txt (statuses C+S for simple, C+F for full) — see
//! bead nscheme-vfp.

/// Simple case folding (status C+S), one char to one char, sorted by key.
pub static SIMPLE: &[(char, char)] = &[
    ('\u{0041}', '\u{0061}'),
    ('\u{0042}', '\u{0062}'),
    ('\u{0043}', '\u{0063}'),
    ('\u{0044}', '\u{0064}'),
...
/// Full case folding (status C+F), one char to one-or-more chars, sorted by key.
pub static FULL: &[(char, &str)] = &[
    ('\u{0041}', "\u{0061}"),
    ('\u{0042}', "\u{0062}"),
    ('\u{0043}', "\u{0063}"),
    ('\u{0044}', "\u{0064}"),
