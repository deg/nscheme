;;; (scheme comparator) — R7RS-large (Red Edition) name for SRFI 128.
;;;
;;; The Red Edition adopts SRFI 128 under the name (scheme comparator);
;;; this library is a thin re-export of our vendored (srfi 128).
