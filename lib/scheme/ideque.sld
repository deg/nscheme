;;; (scheme ideque) — R7RS-large (Red Edition) name for SRFI 134.
;;;
;;; The Red Edition adopts SRFI 134 (immutable deques) under the name
;;; (scheme ideque); this library is a thin re-export of our vendored
;;; (srfi 134).
