;;; (scheme generator) — R7RS-large name for SRFI 158.
;;;
;;; R7RS-large adopts SRFI 158 (Generators and Accumulators) under the
;;; name (scheme generator); this library is a thin re-export of our
;;; vendored (srfi 158).
