;;; (scheme set) — R7RS-large (Red Edition) name for SRFI 113.
;;;
;;; The Red Edition adopts SRFI 113 under the name (scheme set); this
;;; library is a thin re-export of our vendored (srfi 113).
