;;; (scheme mapping) — R7RS-large (Tangerine Edition) name for SRFI 146.
;;;
;;; The Tangerine Edition adopts SRFI 146 under the name (scheme mapping);
;;; this library is a thin re-export of our vendored (srfi 146).
