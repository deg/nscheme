;;; SRFI 14 reference test suite (Olin Shivers). Preamble: import added.
;;; Self-checking: its local (test ...) raises on the first failed form,
;;; so completing without error means every assertion passed.
