;;; SRFI 151 reference test suite (John Cowan, MIT).
;;; Vendored for nscheme conformance: preamble (chibi (use)/import +
;;; current-test-verbosity) replaced with portable imports; assertions verbatim.
(import (scheme base) (srfi 64) (srfi 151))
(test-group "bitwise"
