;;; SRFI 128 reference test suite (John Cowan, MIT).
;;; Vendored for nscheme conformance testing. ONLY the non-portable
;;; preamble ((use test)/(use srfi-128)/(load r7rs-shim)) was replaced
;;; with portable R7RS imports; all test assertions are verbatim.
