;;; SRFI 115 reference test suite (Alex Shinn, BSD). Adapted to nscheme:
;;; unused (srfi 130) import dropped; test framework -> (srfi 64). The
;;; (srfi 115 test) library and all its assertions are otherwise verbatim.
(import (srfi 64))
