;;; SRFI 134 reference test suite (Shiro Kawai). Preamble added: imports +
;;; (srfi 64) framework. Assertions verbatim.
(import (scheme base) (srfi 64) (srfi 1) (srfi 8) (scheme ideque) (scheme generator))
