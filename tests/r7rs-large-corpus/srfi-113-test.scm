;;; SRFI 113 reference test suite (John Cowan, MIT).
;;; Vendored for nscheme conformance: Chicken (use) preamble replaced
;;; with portable imports; the upstream comparators-shim.scm (loaded
;;; relatively) is inlined below; all assertions verbatim.
(import (scheme base) (scheme inexact) (scheme complex)
        (srfi 64) (srfi 1) (srfi 113) (srfi 128))
;;; --- inlined comparators-shim.scm ---
