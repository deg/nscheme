;;; SRFI 159 reference test suite (Duy Nguyen / Alex Shinn). Preamble adapted to (srfi 64).
(import (scheme base) (scheme char) (scheme read) (scheme file)
        (only (srfi 1) circular-list) (srfi 159) (srfi 64))
...
"
      ...
      (let* ((tmp-file "chibi-show-test-0123456789")
        ...
        (call-with-output-file tmp-file (lambda (p) (write-string content-string p)))
